...
function fullscreenFix() {
    ...
    jQuery(".parallax-outer").each(function(i) {
...
function backgroundResize() {
    ...
    jQuery(".background").each(function(i) {
        ...
        var imgsrc = jQuery('.hidden-img').attr("src");
        var ratio = imgW / imgH;
        ...
        if (jQuery(".parallax-wrapper .left-title").size()) {
            jQuery(".parallax-wrapper .left-title").each(function(i) {
                jQuery(this).css("top", (imgH - jQuery(this).height()) / 2);
            });
        }
