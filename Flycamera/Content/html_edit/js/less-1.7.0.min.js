...
!function (a, b) {
  ...
  function t(a, b, c, d, e) {
    ...
    s(a.href, null, function (h, i, j, k, l) {
      if (l) {
        l.remaining = d;
        var n = D && D.getItem(j),
      ...
      m(j),
      i ? (f.currentFileInfo = k, new w.Parser(f).parse(i, function (c, d) {
          if (c)
    ...
    var I = this.imports = {
      ...
      push : function (b, c, d, e) {
        ...
        w.Parser.importer ? w.Parser.importer(b, c, g, a) : w.Parser.fileLoader(b, c, function (b, e, f, h) {
          ...
          d.inline ? g(null, e, f) : new w.Parser(i).parse(e, function (a, b) {
            g(a, b, f)
          })
        }, a)
      }
            ...
            try {
              ...
              if (e.plugins)
                for (j = 0; j < e.plugins.length; j++)
                  e.plugins[j].isPreEvalVisitor ? k.push(e.plugins[j])
                     : e.plugins[j].isPreVisitor ? l.splice(0, 0, e.plugins[j]) : l.push(e.plugins[j]);
  ...
  function (a) {
    ...
    a.JavaScript.prototype = {
      ...
      eval : function (b) {
        ...
        for (var i in h)
          h.hasOwnProperty(i) && (e[i.slice(1)] = {
              value : h[i].value,
              toJS : function () {
          ...
          if ((c = b.frames[f].find(this.selector)).length > 0) {
            ...
            for (g = 0; g < q.length; g++)
              if (l = q[g].group, l === t || l === m)
                try {
                  d = q[g].mixin,
                  d instanceof a.mixin.Definition || (d = new a.mixin.Definition("", [], d.rules, null, !1), d.originalRuleset = c[g].originalRuleset || c[g]),
                  Array.prototype.push.apply(o, d.evalCall(b, e, this.important).rules)
                } catch (w) {
                  throw {
                    message : w.message,
                    index : this.index,
  ...
  function (a) {
    ...
    a.sourceMapOutput.prototype.toCSS = function (a) {
      ...
      if (this._rootNode.genCSS(a, this), this._css.length > 0) {
        ...
        this._sourceMapURL ? d = this._sourceMapURL : this._sourceMapFilename && (d = this.normalizeFilename(this._sourceMapFilename)),
        this._writeSourceMap ? this._writeSourceMap(e) : d = "data:application/json," + encodeURIComponent(e),
