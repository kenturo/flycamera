...
namespace Flycamera.Areas.Administrator.Controllers.Products
{
    ...
    public class ProductsController : Controller
    {
        ...
        // repository
        IRepositryBase<Fly_Product> repository = null;
        IRepositryBase<Fly_Category> _repoCategories = null;
        IRepositryBase<Fly_Manufacturer> _repoManufacturer = null;
        IRepositryBase<Fly_Discount> _repoDiscount = null;
        IRepositryBase<Fly_RelatedProduct> _repoRelatedProduct = null;
        ...
        public ActionResult Edit(ProductVM obj)
        {
            try
            {
                ...
                obj.ProductVariant.isNew = obj.isNew;
                obj.ProductVariant.isGift = obj.isGift;
                obj.ProductVariant.Fly_ProductVariant_Discount_Mapping.Add(new Fly_ProductVariant_Discount_Mapping { DiscountID = obj.indexDiscount, DiscountMappingID = obj.MappingDiscount.DiscountMappingID, ProductVariantID = obj.ProductVariant.ProductVariantId });
                obj.Product.Fly_ProductVariant.Add(obj.ProductVariant);
                ...
                obj.Product.Fly_Product_Category_Mapping.Add(new Fly_Product_Category_Mapping { CategoryID = obj.indexCate, ProductCategoryID = obj.MappingCategories.ProductCategoryID });
                obj.Product.Fly_Product_Manufacturer_Mapping.Add(new Fly_Product_Manufacturer_Mapping { ManufacturerID = obj.indexManufacturer, ProductManufacturerID = obj.MappingManufacturer.ProductManufacturerID });
